...
class TeamWinner : AppCompatActivity() ,MyTimeUpdate{
                            ...
                            if(docRef!=null){
                                db.collection("WinOrLoss$currentUser")
                                    ...
                                    .addOnSuccessListener { documentRef->
                                        Toast.makeText(this@TeamWinner," Your choice $team1", Toast.LENGTH_SHORT).show() }
                                    .addOnFailureListener { e->Toast.makeText(this@TeamWinner," Error $e", Toast.LENGTH_SHORT).show() }
                                finish()
                            }
                            else{
                                db.collection("WinOrLoss$currentUser")
